...
export interface EtapaPayload {
  ...
  motivo_categoria?: MotivoRechazoCat | MotivoStandByCat;
  motivo_detalle?: string;
  decision_por?: string;
  recuperable?: RecuperableOpt;
  fecha_recontacto?: string;
...
export interface FacturadoItem {
  id?: string;         
  nombre: string;
  numero_factura: string;
  fecha_factura: string;
...
export interface WizardPayload {
  ...
  est_costo_mensual_captcha?: number;
  est_costo_mensual_ai?: number;
  est_costo_mensual_idp?: number;
  volumen_transaccional_mensual?: number;
  ...
  prop_hito_inicio_pct: number | '';
  prop_hito_pruebas_pct: number | '';
  prop_hito_estabilizacion_pct: number | '';
  prop_lic_forma_pago: string;
  prop_ocr_forma_pago: string;
  prop_captcha_forma_pago: string;
  prop_soporte_forma_pago: string;
  prop_idp_forma_pago: string;
  prop_ia_forma_pago: string;
  pre_fecha: string;
  pre_resultado: string;
  pre_probabilidad: string;
  apr_aprobado: 'Aprobado' | 'Rechazado' | '';
  apr_fecha: string;
  apr_motivo_rechazo: string;
  apr_estado_id: string;
  apr_consultores_ids: string[];
